# `scripts/interferometer/slam`

Full **SLaM pipeline** runs on interferometer data — the science chains as they are actually run, end
...
```
scripts/interferometer/slam/<target>.py --instrument <inst> --config-name <config> \
